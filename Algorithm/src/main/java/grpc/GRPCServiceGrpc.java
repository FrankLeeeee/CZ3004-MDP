...
public final class GRPCServiceGrpc {
  ...
  public static io.grpc.MethodDescriptor<grpc.GrpcService.MoveRequest,
      grpc.GrpcService.MetricResponse> getTurnLeftMethod() {
    io.grpc.MethodDescriptor<grpc.GrpcService.MoveRequest, grpc.GrpcService.MetricResponse> getTurnLeftMethod;
  ...
  public static io.grpc.MethodDescriptor<grpc.GrpcService.MoveRequest,
      grpc.GrpcService.MetricResponse> getTurnRightMethod() {
    io.grpc.MethodDescriptor<grpc.GrpcService.MoveRequest, grpc.GrpcService.MetricResponse> getTurnRightMethod;
  ...
  public static abstract class GRPCServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void turnLeft(grpc.GrpcService.MoveRequest request,
        io.grpc.stub.StreamObserver<grpc.GrpcService.MetricResponse> responseObserver) {
    ...
    /**
     */
    public void turnRight(grpc.GrpcService.MoveRequest request,
        io.grpc.stub.StreamObserver<grpc.GrpcService.MetricResponse> responseObserver) {
  ...
  public static final class GRPCServiceBlockingStub extends io.grpc.stub.AbstractStub<GRPCServiceBlockingStub> {
    ...
    /**
     */
    public grpc.GrpcService.MetricResponse turnLeft(grpc.GrpcService.MoveRequest request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public grpc.GrpcService.MetricResponse turnRight(grpc.GrpcService.MoveRequest request) {
      return blockingUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_TURN_LEFT:
          serviceImpl.turnLeft((grpc.GrpcService.MoveRequest) request,
              (io.grpc.stub.StreamObserver<grpc.GrpcService.MetricResponse>) responseObserver);
          break;
        case METHODID_TURN_RIGHT:
          serviceImpl.turnRight((grpc.GrpcService.MoveRequest) request,
              (io.grpc.stub.StreamObserver<grpc.GrpcService.MetricResponse>) responseObserver);
          break;
