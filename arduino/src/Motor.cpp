...
double motorfactor = 0.996;    // 0.99775
...
void wallCalibrate()
{
    ...
    // {
    //     getSensorReading();
    //     sensorL_Readings[i] = get_curFiltered1();
    //     sensorR_Readings[i] = get_curFiltered4();
    // }
    ...
    // double sensorL = getDist1(sumL / readSample);
    // double sensorR = getDist4(sumR / readSample);
